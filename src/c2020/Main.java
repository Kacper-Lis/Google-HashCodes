...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String file1 = "src\\c2020\\data\\b_read_on.txt";
        String file2 = "src\\c2020\\data\\c_incunabula.txt";
        String file3 = "src\\c2020\\data\\d_tough_choices.txt";
        String file4 = "src\\c2020\\data\\e_so_many_books.txt";
        String file5 = "src\\c2020\\data\\f_libraries_of_the_world.txt";
        String output = "1.in";
