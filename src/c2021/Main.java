...
public class Main {
    ...
    static String f1 = "src\\c2021\\data\\a.txt";
    static String f2 = "src\\c2021\\data\\b.txt";
    static String f3 = "src\\c2021\\data\\c.txt";
    static String f4 = "src\\c2021\\data\\d.txt";
    static String f5 = "src\\c2021\\data\\e.txt";
    static String f6 = "src\\c2021\\data\\f.txt";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        Parser parser = new Parser(new File(f1)); //change input name here
